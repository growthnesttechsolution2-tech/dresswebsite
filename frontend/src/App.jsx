  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/dress" element={<UserLayout><UserRoute><ProductList category="Women's Dress" /></UserRoute></UserLayout>} />
        <Route path="/jewellery" element={<UserLayout><UserRoute><ProductList category="Jewellery" /></UserRoute></UserLayout>} />
        <Route path="/product/:id" element={<UserLayout><UserRoute><ProductDetails /></UserRoute></UserLayout>} />
